...
maxd <- as.Date("2022-10-06", tz = "Etc/GMT-2")

# raw_data_dir <- "/scratch/project_2003061/microclim/Tiilikka"
raw_data_dir <- "C:/Users/OMISTAJA/OneDrive - University of Helsinki/Kesä2022/Tiilikka_pisa_data_2022/Pisa"
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-09-14")))
probls <- c(as_date(as_date("2022-05-11"):as_date("2022-10-06")))
hattu <- c()
