...
data_dir <- "C:/Users/OMISTAJA/OneDrive - University of Helsinki/Kesä2022/Tiilikka_pisa_data_2022/Pisa"
data_dir_old <- "C:/Users/OMISTAJA/Documents/repos/Pisa_microclimates/data"
...
# maxdt %>% filter(site == "110")
# maxdt %>% filter(tomst_id == "94194270")
# fi %>% filter(site == "26")
# Problems solved...
...
# No sites that occur only in 2022 data

#site 2 in 2021 data but not in 2022

# For site 2 find 2021 data and copy to repository
f2 <- list.files(data_dir_old,
                 pattern = "data_", recursive = T, full.names = T)

# Copy site 2 data from last year data
f2[grepl("94194265", f2)]
dir.create(paste0(data_dir, "/2"))
file.copy(f2[grepl("94194265", f2)],
          paste0(data_dir, "/2/data_94194265_0.csv"))
